...
xdescribe('ReportService', () => {
    ...
    */
    ...
    xit('updates report', async function (done) {
    ...
    xit('gets report', async function (done) {
    ...
    xit('get all reports', async function (done) {
    ...
    //         let resGet = await reportService.getByDateType(date, dataType);
    //         expect(resGet).toBeDefined();

    //         // get all reports by type
    //         let resGetType = await reportService.getByDateType(date);
